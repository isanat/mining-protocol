  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-sm text-gray-400">Gerencie a plataforma</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 gap-3">
          {adminCards.map((card, index) => (
            <Card key={index} className="mobile-card hover:border-white/20 transition-colors cursor-pointer">
              <CardContent className="p-4">
                <div className={cn(
      ...
      <Card className="mobile-card">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { type: "deposit", user: "user@email.com", amount: "$ 500 USDT", time: "2 min" },
              { type: "withdrawal", user: "user2@email.com", amount: "$ 200 USDT", time: "5 min" },
              { type: "register", user: "novo@email.com", amount: "Novo usuário", time: "10 min" },
            ].map((activity, index) => (
              <div key={index} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
                <div className="flex items-center gap-3">
                  <div className={cn(
                    ...
                    activity.type === "withdrawal" ? "bg-red-500/20" : "bg-blue-500/20"
                  )}>
